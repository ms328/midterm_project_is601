...
class Operation(ABC):
    ...
    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        """Execute the operation and return a Decimal result."""

    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        """Default no-op validation. Subclasses may override."""
        return None
...
class Modulus(Operation):
    ...
    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        super().validate_operands(a, b)
        if b == 0:
            raise ValidationError("Modulo by zero is not allowed")
...
class OperationFactory:
    """Factory for creating operation instances and registering new ones."""
